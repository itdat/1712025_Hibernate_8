...
public class ChangePassword extends RoundedJFrame {
    ...
    private void initComponents() {
        ...
        loginFormTitle.setFont(new Font("Roboto", 0, 36)); // NOI18N
        ...
        password.setFont(new Font("Roboto", 0, 18)); // NOI18N
        password.setToolTipText("");

        passwordLabel.setFont(new Font("Roboto", 0, 18)); // NOI18N
        passwordLabel.setText("Mật khẩu hiện tại");

        loginButton.setBackground(new Color(0, 102, 153));
        loginButton.setFont(new Font("Roboto", 1, 18)); // NOI18N
        ...
        jLabel4.setFont(new Font("Roboto", 2, 14)); // NOI18N
        jLabel4.setForeground(new Color(102, 102, 102));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Quên mật khẩu?");

        passwordLabel1.setFont(new Font("Roboto", 0, 18)); // NOI18N
        passwordLabel1.setText("Mật khẩu mới");

        password1.setBackground(new Color(240, 240, 240));
        password1.setFont(new Font("Roboto", 0, 18)); // NOI18N
        password1.setToolTipText("");

        password2.setBackground(new Color(240, 240, 240));
        password2.setFont(new Font("Roboto", 0, 18)); // NOI18N
        password2.setToolTipText("");

        passwordLabel2.setFont(new Font("Roboto", 0, 18)); // NOI18N
