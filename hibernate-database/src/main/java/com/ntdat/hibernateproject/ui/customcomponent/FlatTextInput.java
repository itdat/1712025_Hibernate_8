...
public class FlatTextInput extends JTextField {  
    ...
    protected void paintComponent(Graphics g) {  
        ...
        g2.fillRoundRect(1, 1, getWidth() - 2, getHeight() - 2, this.Ae_borderRadius, this.Ae_borderRadius);
        if (getText().length() < 1) {  
    ...
    protected void paintBorder(Graphics g) {   
        ...
        g2.drawRoundRect(1, 1, getWidth() - 2, getHeight() - 2, this.Ae_borderRadius, this.Ae_borderRadius);
        g2.dispose();
    }  
